...
const (
	...
	CodecIDMPEG2VIDEO      CodecID = C.AV_CODEC_ID_MPEG2VIDEO ///< preferred ID for MPEG-1/2 video decoding
	...
	CodecIDIFF_ILBM        CodecID = C.AV_CODEC_ID_IFF_ILBM // alias AV_CODEC_ID_IFF_BYTERUN1
	...
	CodecIDA64_MULTI       CodecID = C.AV_CODEC_ID_A64_MULTI
	CodecIDA64_MULTI5      CodecID = C.AV_CODEC_ID_A64_MULTI5
	...
	CodecIDBMV_VIDEO       CodecID = C.AV_CODEC_ID_BMV_VIDEO
	...
	CodecIDHNM4_VIDEO      CodecID = C.AV_CODEC_ID_HNM4_VIDEO
	CodecIDHEVC            CodecID = C.AV_CODEC_ID_HEVC // alias AV_CODEC_ID_H265
	...
	CodecIDVVC             CodecID = C.AV_CODEC_ID_VVC // alias AV_CODEC_ID_H266
	...
	CodecIDSIMBIOSIS_IMX CodecID = C.AV_CODEC_ID_SIMBIOSIS_IMX
	CodecIDSGA_VIDEO     CodecID = C.AV_CODEC_ID_SGA_VIDEO
	...
	CodecIDRADIANCE_HDR  CodecID = C.AV_CODEC_ID_RADIANCE_HDR
	...
	// various PCM "codecs"
	CodecIDFIRST_AUDIO      CodecID = C.AV_CODEC_ID_FIRST_AUDIO ///< A dummy id pointing at the start of audio codecs
	...
	CodecIDPCM_VIDC         CodecID = C.AV_CODEC_ID_PCM_VIDC
	CodecIDPCM_SGA          CodecID = C.AV_CODEC_ID_PCM_SGA
	...
	CodecIDADPCM_AGM         CodecID = C.AV_CODEC_ID_ADPCM_AGM
	CodecIDADPCM_ARGO        CodecID = C.AV_CODEC_ID_ADPCM_ARGO
	CodecIDADPCM_IMA_SSI     CodecID = C.AV_CODEC_ID_ADPCM_IMA_SSI
	CodecIDADPCM_ZORK        CodecID = C.AV_CODEC_ID_ADPCM_ZORK
	CodecIDADPCM_IMA_APM     CodecID = C.AV_CODEC_ID_ADPCM_IMA_APM
	CodecIDADPCM_IMA_ALP     CodecID = C.AV_CODEC_ID_ADPCM_IMA_ALP
	CodecIDADPCM_IMA_MTF     CodecID = C.AV_CODEC_ID_ADPCM_IMA_MTF
	CodecIDADPCM_IMA_CUNNING CodecID = C.AV_CODEC_ID_ADPCM_IMA_CUNNING
	CodecIDADPCM_IMA_MOFLEX  CodecID = C.AV_CODEC_ID_ADPCM_IMA_MOFLEX
	CodecIDADPCM_IMA_ACORN   CodecID = C.AV_CODEC_ID_ADPCM_IMA_ACORN
	CodecIDADPCM_XMD         CodecID = C.AV_CODEC_ID_ADPCM_XMD
	...
	CodecIDDERF_DPCM      CodecID = C.AV_CODEC_ID_DERF_DPCM
	CodecIDWADY_DPCM      CodecID = C.AV_CODEC_ID_WADY_DPCM
	CodecIDCBD2_DPCM      CodecID = C.AV_CODEC_ID_CBD2_DPCM

	// audio codecs

	CodecIDMP2             CodecID = C.AV_CODEC_ID_MP2
	CodecIDMP3             CodecID = C.AV_CODEC_ID_MP3 ///< preferred ID for decoding MPEG audio layer 1, 2 or 3
	...
	CodecIDGSM             CodecID = C.AV_CODEC_ID_GSM ///< as in Berlin toast format
	...
	CodecIDGSM_MS          CodecID = C.AV_CODEC_ID_GSM_MS // as found in WAV
	...
	CodecIDACELP_KELVIN    CodecID = C.AV_CODEC_ID_ACELP_KELVIN
	CodecIDMPEGH_3D_AUDIO  CodecID = C.AV_CODEC_ID_MPEGH_3D_AUDIO
	...
	CodecIDFIRST_SUBTITLE     CodecID = C.AV_CODEC_ID_FIRST_SUBTITLE ///< A dummy ID pointing at the start of subtitle codecs.
	CodecIDDVD_SUBTITLE       CodecID = C.AV_CODEC_ID_DVD_SUBTITLE
	CodecIDDVB_SUBTITLE       CodecID = C.AV_CODEC_ID_DVB_SUBTITLE
	CodecIDTEXT               CodecID = C.AV_CODEC_ID_TEXT ///< raw UTF-8 text
	...
	CodecIDARIB_CAPTION       CodecID = C.AV_CODEC_ID_ARIB_CAPTION

	// other specific kind of codecs (generally used for attachments)

	CodecIDFIRST_UNKNOWN CodecID = C.AV_CODEC_ID_FIRST_UNKNOWN ///< A dummy ID pointing at the start of various fake codecs.
	CodecIDTTF           CodecID = C.AV_CODEC_ID_TTF

	CodecIDSCTE_35   CodecID = C.AV_CODEC_ID_SCTE_35 ///< Contain timestamp estimated through PCR of program stream.
	...
	// CodecIDSMPTE_2038 CodecID = C.AV_CODEC_ID_SMPTE_2038

	CodecIDPROBE CodecID = C.AV_CODEC_ID_PROBE ///< codec_id is not known (like AV_CODEC_ID_NONE) but lavf should attempt to identify it

	CodecIDMPEG2TS         CodecID = C.AV_CODEC_ID_MPEG2TS         ///< _FAKE_ codec to indicate a raw MPEG-2 TS stream (only used by libavformat)
	CodecIDMPEG4SYSTEMS    CodecID = C.AV_CODEC_ID_MPEG4SYSTEMS    ///< _FAKE_ codec to indicate a MPEG-4 Systems stream (only used by libavformat)
	CodecIDFFMETADATA      CodecID = C.AV_CODEC_ID_FFMETADATA      ///< Dummy codec for streams containing only metadata information.
	CodecIDWRAPPED_AVFRAME CodecID = C.AV_CODEC_ID_WRAPPED_AVFRAME ///< Passthrough codec, AVFrames wrapped in AVPacket
...
func (cid CodecID) Name() string {
	return C.GoString(C.avcodec_get_name(uint32(cid)))
}
